...
SERIAL_PORT = 'COM3' #CHANGE THIS; DEPENDS ON COMPUTER (Look up what port the Arduino is communicating with)
...
while(True):
    ...
    # Normalize and clip measurements from flex sensors to get frequency weights
    ...
    # Useful if you want to dynamically change chord frequencies with a new potentiometer
